...
def get_dollar_estimate(rm, ptratio, chas = False, large_range = True):
    ...
    ptratio - > No. of students per teacher ratio in the classroom for the school in the area
    chas -> True if the property is next to the river or else False
    large_range -> True for 95% prediction interval and False for 68% prediction interval
    
    """
    
    
    if rm < 1 or ptratio < 1:
        print('Unrealistic da punda!! Try again')
        return
